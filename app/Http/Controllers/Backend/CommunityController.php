...
class CommunityController extends Controller
{
    ...
    public function store(CommunityStoreRequest $request)
    {
        ...
        return to_route('communities.index')->with('message', 'La communauté a bien été créée');;
    }
    ...
    public function update(CommunityStoreRequest $request, Community $community)
    {
        ...
        return to_route('communities.index')->with('message', 'La communauté a bien été modifiée');
    }
    ...
    {
        $community->delete();
        return back()->with('message', 'La communauté a bien éte supprimée.');
    }
}
